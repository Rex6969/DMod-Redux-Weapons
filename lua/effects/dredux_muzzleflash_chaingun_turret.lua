...
function EFFECT:Render()
	...
	local pos1 = self:GetTracerShootPos( self.Pos, self.Weapon, 2 )
	local pos2 = self:GetTracerShootPos( self.Pos, self.Weapon, 3 )
	local pos3 = self:GetTracerShootPos( self.Pos, self.Weapon, 4 )
	
	render.SetMaterial( self.Material[ math.random( 3 ) ] )
	render.DrawSprite(pos1, self.Size, self.Size, Color( 255, 240, 230, 255 ) )
	
	render.SetMaterial( self.Material[ math.random( 3 ) ] )
	render.DrawSprite(pos2, self.Size, self.Size, Color( 255, 240, 230, 255 ) )
	
	render.SetMaterial( self.Material[ math.random( 3 ) ] )
	render.DrawSprite(pos3, self.Size, self.Size, Color( 255, 240, 230, 255 ) )
	
	--
	
	render.SetMaterial( self.GlowMaterial )
	render.DrawSprite(pos1, self.Size * 2, self.Size * 2, Color( 255, 60, 0, 10 ) )
	
	render.SetMaterial( self.GlowMaterial )
	render.DrawSprite(pos2, self.Size * 2, self.Size * 2, Color( 255, 60, 0, 10 ) )
	
	render.SetMaterial( self.GlowMaterial )
	render.DrawSprite(pos3, self.Size * 2, self.Size * 2, Color( 255, 60, 0, 10 ) )
